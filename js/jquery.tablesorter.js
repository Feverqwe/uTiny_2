    ...
    $.extend({
        ...
        tablesorter: new function() {
            ...
            function buildHeaders(table) {
                ...
                $tableHeaders = $(c.selectorHeaders).each(function(index) {
                    $t = $(this);
                    ch = c.headers[index];
            ...
            ts.construct = function(settings) {
                return this.each(function() {
                    ...
                    if (c.debug) {
                        $.data($t0, 'startoveralltimer', new Date());
                    }
                    // constants
                    ...
                    c.$headers
                        ...
                        if (external !== true && (new Date().getTime() - downTime > 250)) {
                            return false;
                        }
                    ...
                    $this.unbind('sortReset update updateCell addRows sorton appendCache applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave '.split(' ').join('.tablesorter '))
