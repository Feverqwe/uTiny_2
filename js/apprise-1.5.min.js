function apprise(string, args, callback)
{
    ...
    if (args)
    {
...

        {
            ...
            for (var i = 0; i < args['select'].length; i++) {
                var item = args['select'][i];
                items += '<option value="' + i + '">' + item[1] + '</option>';
            }
            $('.appriseInner').append('<div class="aInput"><select class="aSelect" >' + items + '</select></div>');
    ...
    if (args)
    {
        if (args['confirm'] || args['input'] || args['select'])
