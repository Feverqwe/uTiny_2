...
const defaultTorrentListColumnList = [
  ...
  {column: 'avail', display: 0, order: 1, width: 64, lang: 'OV_COL_AVAIL'},
  {column: 'label', display: 0, order: 1, width: 104, lang: 'OV_COL_LABEL'},
  ...
  {column: 'actions', display: 1, order: 0, width: 61, lang: 'Actions'}
];
